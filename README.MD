...
|     |     |
| ------------- | ------------- |
| ![Example!](example_outputs/mcrproto.gif?raw=true)  | ![Example!](example_outputs/ray_traced_cubes.PNG?raw=true)  |
| ![Example!](example_outputs/mcrproto.PNG?raw=true)  | ![Example!](example_outputs/cubemorph.gif?raw=true)  |
