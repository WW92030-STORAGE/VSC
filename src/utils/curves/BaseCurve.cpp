...
#include "../../../include/utils/curves/BaseCurve.h"
    ...
    BaseCurve::BaseCurve(std::vector<Vector3> v) {
        controls = std::vector<Vector3>(v);
        size = controls.size();
    }
    
    Vector3 BaseCurve::query(float t) {
        t = BASE::clamp(t, 0, 1);
    ...
    std::string BaseCurve::to_string() {
    ...
    BaseSurface::BaseSurface(std::vector<std::vector<Vector3>> v) {
    ...
    std::vector<Vector3> BaseSurface::getUCurve(float u) {
    ...
    Vector3 BaseSurface::query(float u, float v) {
        u = BASE::clamp(u, 0, 1);
        v = BASE::clamp(v, 0, 1);
    ...
    // Vector2 topleft = Vector2(0, 0), Vector2 topright = Vector2(1, 0), Vector2 botleft = Vector2(0, 1), Vector2 botright = Vector2(1, 1)

    Mesh BaseSurface::ctrlmesh(Vector2 topleft, Vector2 topright, Vector2 botleft, Vector2 botright) {
    ...
    // int cellsU = 1, int cellsV = 1, Vector2 topleft = Vector2(0, 0), Vector2 topright = Vector2(1, 0), Vector2 botleft = Vector2(0, 1), Vector2 botright = Vector2(1, 1)
    
    Mesh BaseSurface::render(int cellsU, int cellsV, Vector2 topleft, Vector2 topright, Vector2 botleft, Vector2 botright) {
