...
// Split triangle only
static std::pair<std::vector<Triangle3>, std::vector<Triangle3>> TriSplit(Triangle3 t, Plane splane) {
...
template <typename T>
static std::pair<std::vector<std::vector<T>>, std::vector<std::vector<T>>> TriSplitAttr(Triangle3 t, Plane splane, std::vector<T> attr) {
