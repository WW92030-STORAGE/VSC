...
Scene scene_protospheres() {
	...
	Mesh cube1 = icosphere(0.5, 3);
	Mesh cube2 = icosphere(0.5, 3);
...
Scene scene_stresstest() {
	...
	Mesh ball1 = icosphere(1, 4);
	Mesh ball2 = icosphere(1, 4);

	ball1.Trans(Transform(Vector3(0, 0, -2)));
	ball2.Trans(Transform(Vector3(1, 0, -3)));
	...
	s.addMesh(&ball1, &red, true);
	s.addMesh(&ball2, &cyan, true);
